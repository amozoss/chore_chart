...
#
#     PHX_SERVER=true bin/chore_chart start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :chore_chart, ChoreChartWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  secret_key_base =
    System.get_env("CHORE_CHART_SECRET_KEY_BASE") ||
      raise """
      environment variable SECRET_KEY_BASE is missing.
      You can generate one by calling: mix phx.gen.secret
      """

  host = System.get_env("CHORE_CHART_PHX_HOST") || "example.com"
  port = String.to_integer(System.get_env("CHORE_CHART_PHX_PORT") || "4000")
  ...
  #
  #     config :chore_chart, ChoreChart.Mailer,
